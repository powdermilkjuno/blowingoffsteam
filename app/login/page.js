...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center px-6 py-16">
      ...
      <Card className="w-full max-w-sm p-7 animate-rise">
        ...
        <form className="mt-7 space-y-4">
          <Field id="username" label="Username" placeholder="yourname" autoComplete="username" />
          <Field
            id="password"
            label="Password"
            type="password"
          ...
          <div className="flex items-center justify-between pt-1 text-xs">
            ...
            <Link href="#" className="text-fern hover:text-signal">
              Forgot password?
            </Link>
          </div>

          <Button variant="primary" className="mt-2 w-full" href="/dashboard">
            Log in
          </Button>
        </form>
      </Card>
