    ...
    <div className="min-h-screen">
      ...
      <section className="relative mx-auto max-w-6xl px-6 pb-20 pt-10 md:pt-16">
        ...
        <div className="grid items-center gap-14 md:grid-cols-2">
          ...
          <TerminalWindow title="dashboard.preview" className="animate-rise [animation-delay:120ms]">
            <div className="space-y-1.5 text-sm">
              <p className="text-muted">
                <span className="text-clay">$</span> uptime status
              </p>
              <p className="text-paper">tracking: <span className="text-signal">connected</span></p>
              <p className="text-paper">this week: <span className="text-clay">21h 46m</span></p>
              <p className="text-paper">rank: <span className="text-signal">#3</span> of 12 friends</p>
            </div>
      ...
      <section className="mx-auto max-w-6xl border-t border-line px-6 py-16">
        <div className="grid gap-10 md:grid-cols-5">
          <div className="md:col-span-3">
            ...
            <p className="mt-2 max-w-sm text-sm leading-relaxed text-muted">{hero.body}</p>
            ...
            <div className="mt-6 flex items-center gap-1.5">
              ...
              <span className="ml-2 text-xs text-muted">6-day streak this week</span>
            </div>
          </div>
